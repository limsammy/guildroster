...
Revision ID: 4601db019b3d
Revises: 32a78ec223d5
Create Date: 2025-07-14 01:16:56.381124
...
revision: str = '4601db019b3d'
down_revision: Union[str, Sequence[str], None] = '32a78ec223d5'
...
def upgrade() -> None:
    ...
    sa.CheckConstraint("name != ''", name='ck_scenario_name_not_empty'),
