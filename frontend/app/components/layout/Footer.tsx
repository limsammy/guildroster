        ...
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="/help" className="text-slate-300 hover:text-white transition-colors duration-200">
                    Help Center
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/status" className="text-slate-300 hover:text-white transition-colors duration-200">
                    Status
                  </a>
                </li>
                <li>
